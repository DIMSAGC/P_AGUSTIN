...
**Estadística descriptiva.**Se refiere a los métodos de recolección, organización, resumen y presentación de un conjunto de datos. Se trata principalmente de describir las características fundamentales de los datos y para ellos se suelen utilizar indicadores, gráficos y tablas. https://economipedia.com/definiciones/estadistica.html

**Estadística inferencial.**Se refiere a los métodos utilizados para poder hacer predicciones, generalizaciones y obtener conclusiones a partir de los datos analizados teniendo en cuenta el grado de incertidumbre existente. https://economipedia.com/definiciones/estadistica.html
